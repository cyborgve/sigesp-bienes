...
export class SegurosService {
  ...
  public getAllInsurance() {
    return this.http
      .get(`${this.sigesp.URL}/dao/sbn/seguros_dao.php`, {
  ...
  public saveInsurance(formGroup: FormGroup, id: number) {
    ...
    return this.http
      .post(`${this.sigesp.URL}/dao/sbn/seguros_dao.php`, body, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {
  ...
  public updateInsurance(formGroup: FormGroup, id: number) {
    const body = this.getBody(formGroup, id);
    return this.http
      .put(`${this.sigesp.URL}/dao/sbn/seguros_dao.php`, body, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {
  ...
  public deleteInsurance(codigo: number) {
    return this.http
      .delete(`${this.sigesp.URL}/dao/sbn/seguros_dao.php?codigo=${codigo}`, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {

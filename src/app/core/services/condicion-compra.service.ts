...
export class CondicionCompraService {
  ...
  public getAllBuyCondition(){    
    return this.http.get(`${this.sigesp.URL}/dao/sbn/condicion_compra_dao.php?`,
  ...
  public saveBuyCondition(formGroup: FormGroup){ 
    ...
    return this.http.post(`${this.sigesp.URL}/dao/sbn/condicion_compra_dao.php`, body, {
      headers: this.sigesp.getHttpHeaders()
    }).pipe(  
       map((res: any) => {
          if (res.success) {
  ...
  public updateBuyCondition(formGroup: FormGroup, id: number){ 
    ...
    return this.http.put(`${this.sigesp.URL}/dao/sbn/condicion_compra_dao.php`, body, {
      headers: this.sigesp.getHttpHeaders()
    }).pipe(  
       map((res: any) => {
          if (res.success) {
  ...
  public deleteBuyCondition(codigo:number){ 
    return this.http.delete(`${this.sigesp.URL}/dao/sbn/condicion_compra_dao.php?codigo=${codigo}`, {
    headers: this.sigesp.getHttpHeaders() 
  })
  .pipe(
    map((res:any) => {

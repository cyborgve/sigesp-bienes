...
export class CatalogoGeneralService {
  ...
  public getAllGeneralCatalog() {
    return this.http
      .get(`${this.sigesp.URL}/dao/sbn/catalogo_general_dao.php?`, {
  ...
  public saveGeneralCatalog(formGroup: FormGroup, cuenta: string) {
    ...
    return this.http
      .post(`${this.sigesp.URL}/dao/sbn/catalogo_general_dao.php`, body, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {
  ...
  public updateGeneralCatalog(formGroup: FormGroup, cuenta: string) {
    ...
    return this.http
      .put(`${this.sigesp.URL}/dao/sbn/catalogo_general_dao.php`, body, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {
  ...
  public deleteGeneralCatalog(codigo: string) {
    return this.http
      .delete(
        `${this.sigesp.URL}/dao/sbn/catalogo_general_dao.php?codigo=${codigo}`,
        {
          headers: this.sigesp.getHttpHeaders(),
        }
      )

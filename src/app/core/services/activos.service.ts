...
export class ActivosService {
  ...
  public getUnitMeasurement() {
    ...
    return this.http.get(`${this.sigesp.URL}/dao/siv/unidadMedida_dao.php?operacion=${operacion}`,
    {headers: {
  ...
  public getAccountPlanGeneral(){
    let egreso="egreso"
    return this.http.get(`${this.sigesp.URL}/dao/scg/plan_cuentas_recursos_egresos_dao.php?egreso=${egreso}`,
  ...
  public getLastActive(catalog:string){
    return this.http.get(`${this.sigesp.URL}/dao/sbn/activo_dao.php?catalog=${catalog}`,
    {headers: this.sigesp.getHttpHeaders()})
    .pipe(
      map((res:any)=>{
        if(res.success){
  ...
  public getActive(){
    return this.http.get(`${this.sigesp.URL}/dao/sbn/activo_dao.php?`,
    {headers: this.sigesp.getHttpHeaders()})
    .pipe(
      map((res:any)=>{
        if(res.success){
  ...
  public saveActive(active:MActivo){ 
     ...
     console.log(body)
     return this.http.post(`${this.sigesp.URL}/dao/sbn/activo_dao.php`, body, {
       headers: this.sigesp.getHttpHeaders()
     }).pipe(  
        map((res: any) => {
           if (res.success) {
   ...
   public deleteActive(codigo:number){ 
    return this.http.delete(`${this.sigesp.URL}/dao/sbn/activo_dao.php?codigo=${codigo}`, {
    headers: this.sigesp.getHttpHeaders() 
  })
  .pipe(
    map((res:any) => {
...
public updateActive(active:MActivo){ 
  const body = this.getBody(active)
  return this.http.put(`${this.sigesp.URL}/dao/sbn/activo_dao.php`, body, {
    headers: this.sigesp.getHttpHeaders()
  }).pipe(  
     map((res: any) => {
        if (res.success) {
...
public getNetCode(serial:string){
    return this.http.get(`${this.sigesp.URL}/dao/sbn/activo_dao.php?serial=${serial}`,
    {headers: {
      Authorization: this.sigesp.usuarioActivo.token
    }}).pipe(
      map((res:any)=>{

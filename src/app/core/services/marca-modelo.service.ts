...
export class MarcaModeloService {
  ...
  public getAllBrand(){
    return this.http.get(`${this.sigesp.URL}/dao/sbn/marcas_dao.php`,
  ...
  public getBrandModels(idMarca:number){
    return this.http.get(`${this.sigesp.URL}/dao/sbn/modelos_dao.php?codigo=${idMarca}`,
    {headers: this.sigesp.getHttpHeaders()})
    .pipe(
      map((res:any)=>{
        if(res.success){
  ...
  public saveBrand(formGroup:FormGroup, modelo:MModelo[]){
    ...
    return this.http.post(`${this.sigesp.URL}/dao/sbn/marcas_dao.php`, body, {
      headers: this.sigesp.getHttpHeaders()
    }).pipe(  
       map((res: any) => {
          if (res.success) {
  ...
  public updateBrand(formGroup:FormGroup, idMarca:number, modelo:MModelo[]){
    ...
    return this.http.put(`${this.sigesp.URL}/dao/sbn/marcas_dao.php`, body, {
      headers: this.sigesp.getHttpHeaders()
    }).pipe(  
       map((res: any) => {
          if (res.success) {
  ...
  public deleteBrand(codigo:number){ 
    return this.http.delete(`${this.sigesp.URL}/dao/sbn/marcas_dao.php?codigo=${codigo}`, {
     headers: this.sigesp.getHttpHeaders() 
    })
    .pipe(
      map((res:any) => {
  ...
  public deleteModels(delComponetes:MModelo[]){ 
    ...
    return this.http.delete(`${this.sigesp.URL}/dao/sbn/modelos_dao.php?ids=${ids}`, {
    headers: this.sigesp.getHttpHeaders() 
  })
  .pipe(
    map((res:any) => {

...
export class SedesService {
  ...
  public getAllSeat(){
    return this.http.get(`${this.sigesp.URL}/dao/sbn/sedes_dao.php`,
  ...
  public getCiudad(){
    return this.http.get(`${this.sigesp.URL}/dao/sigesp/ciudad_dao.php`,
    {headers: this.sigesp.getHttpHeaders()})
    .pipe(
  ...
  public saveSeat(formGroup:FormGroup){
    ...
    return this.http.post(`${this.sigesp.URL}/dao/sbn/sedes_dao.php`, body, {
      headers: this.sigesp.getHttpHeaders()
    }).pipe(  
       map((res: any) => {
          if (res.success) {
  ...
  public updateSeat(formGroup:FormGroup, id:number){
    ...
    return this.http.put(`${this.sigesp.URL}/dao/sbn/sedes_dao.php`, body, {
      headers: this.sigesp.getHttpHeaders()
    }).pipe(  
       map((res: any) => {
          if (res.success) {
  ...
  public deleteSeat(codigo:number){ 
    return this.http.delete(`${this.sigesp.URL}/dao/sbn/sedes_dao.php?codigo=${codigo}`, {
     headers: this.sigesp.getHttpHeaders() 
    })
    .pipe(
      map((res:any) => {

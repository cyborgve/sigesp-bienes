import {
  MEstructuraPredominante,
  MComponenteEstructura,
} from './../models/MestructuraPredominante';
...
export class EstructuraPredominanteService {
  ...
  public getAllPredominantStructure() {
    return this.http
      .get(`${this.sigesp.URL}/dao/sbn/estructura_predominante_dao.php?`, {
        ...
        map((res: any) => {
          if (res.success) {
            res.data = res.data.map(
              element => new MEstructuraPredominante(element)
            );
          } else {
            res.data = [];
          }
  ...
  public getStructureComponent(id: number) {
    return this.http
      .get(
        `${this.sigesp.URL}/dao/sbn/componente_estructura_dao.php?idTipo=${id}`,
        { headers: this.sigesp.getHttpHeaders() }
      )
      .pipe(
        map((res: any) => {
          if (res.success) {
            res.data = res.data.map(
              element => new MComponenteEstructura(element)
            );
          } else {
            res.data = [];
          }
  ...
  public savePredominantStructure(formGroup: FormGroup) {
    ...
    return this.http
      .post(
        `${this.sigesp.URL}/dao/sbn/estructura_predominante_dao.php`,
        body,
        {
          headers: this.sigesp.getHttpHeaders(),
        }
  ...
  public updatePredominantStructure(
    denominacion: string,
    id: number,
    componente: MComponenteEstructura[]
  ) {
    let componentes = [];
    ...
    return this.http
      .put(`${this.sigesp.URL}/dao/sbn/estructura_predominante_dao.php`, body, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {
  ...
  public deletePredominantStructure(codigo: number) {
    return this.http
      .delete(
        `${this.sigesp.URL}/dao/sbn/estructura_predominante_dao.php?codigo=${codigo}`,
        {
          headers: this.sigesp.getHttpHeaders(),
        }
      )
  ...
  public deleteComponet(delComponetes: MComponenteEstructura[]) {
    ...
    return this.http
      .delete(
        `${this.sigesp.URL}/dao/sbn/componente_estructura_dao.php?ids=${ids}`,
        {
          headers: this.sigesp.getHttpHeaders(),
        }
      )

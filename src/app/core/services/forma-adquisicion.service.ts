...
export class FormaAdquisicionService {
  ...
  public getAcquisitionMethod() {
    return this.http
      .get(`${this.sigesp.URL}/dao/sbn/forma_adquisicion_dao.php?`, {
  ...
  public saveAcquisitionMethod(formGroup: FormGroup) {
    ...
    return this.http
      .post(`${this.sigesp.URL}/dao/sbn/forma_adquisicion_dao.php`, body, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {
  ...
  public updateAcquisitionMethod(formGroup: FormGroup, id: number) {
    ...
    return this.http
      .put(`${this.sigesp.URL}/dao/sbn/forma_adquisicion_dao.php`, body, {
        headers: this.sigesp.getHttpHeaders(),
      })
      .pipe(
        map((res: any) => {
  ...
  public deleteAcquisitionMethod(codigo: number) {
    return this.http
      .delete(
        `${this.sigesp.URL}/dao/sbn/forma_adquisicion_dao.php?codigo=${codigo}`,
        {
          headers: this.sigesp.getHttpHeaders(),
        }
      )

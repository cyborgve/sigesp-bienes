...
export const adaptarAutorizacionesSalida = () =>
  pipe(
    map((autorizacionesSalida: any[]) =>
      autorizacionesSalida.map(
        autorizacionSalida =>
          <AutorizacionSalida>{
            ...
            unidadAdministrativa: Number(
              autorizacionSalida.unidadAdministrativa
            ),
            ...
            activos: autorizacionSalida.activos
              ? autorizacionSalida.activos
              : [],

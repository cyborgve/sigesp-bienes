...
export class OrigenActivoComponent implements OnInit {
  ...
  public openCatalogoOrigin() {
    ...
    if (this.origin.length > 0) {
      this.sigesp
        .openCatalogoGenerico(columnas, tittle, this.origin, nameColummnas)
        .then((resp: MOrigen) => {
          if (resp != null) {
  ...
  public assignData(data: any) {
    ...
    this.formOrigen
      ...
      .setValue(data.fechaFormaAdquisicion);
    this.formOrigen
      .get('numeroFormaAdquisicion')
      .setValue(data.numeroFormaAdquisicion);
    this.formOrigen
      .get('nombreFormaAdquisicion')
      .setValue(data.nombreFormaAdquisicion);
    ...
    this.formOrigen
      ...
      .setValue(data.nomprePropietarioAnterior);
    this.formOrigen
      .get('beneficiarioCedente')
      .setValue(data.nombreBeneficiarioCedente);
    this.formOrigen
      .get('beneficiarioReceptor')
      .setValue(data.nombreBeneficiarioReceptor);

...
export class ResponsableActivoComponent implements OnInit {
  ...
  public showData(){
    if (this.dataGeneral != undefined){     
      this.formResponsable.get('dependenciaResponsable').setValue(this.dataGeneral.idUnidadAdministrativaBien)
      this.formResponsable.get('dependenciaUbicacion').setValue(this.dataGeneral.idSede)
      this.formResponsable.get('responsableAdministrativo').setValue(this.dataGeneral.id_Responsable)
      this.formResponsable.get('responsableUso').setValue(this.dataGeneral.idResponsableUso)
      this.formResponsable.get('responsableCuido').setValue(this.dataGeneral.id_Responsable)
    }
  }

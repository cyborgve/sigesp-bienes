...
@Component({
  ...
  templateUrl: './singular-tipo-componente.component.html',
  styleUrls: ['./singular-tipo-componente.component.scss'],
})
export class SingularTipoComponenteComponent extends AbstractEntidadFunciones {
  modoFormulario: ModoFormulario = 'CREANDO';
  id: Id;
  titulo = 'tipo componente';
  ...
  guardar() {
    let entidad: TipoComponente = this.formulario.value;
